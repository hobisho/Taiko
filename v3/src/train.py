...
num_heads = 4          # Transformer 的多頭注意力數量
num_layers = 2         # Transformer Encoder 的層數
num_samples = 1      # 模擬資料筆數
seq_length = 8159
orig_H, orig_W, C = 400, 600, 3
scale = 0.01
...
if __name__ == "__main__":
    ...
    file_list = [f"G://Mel_tfrecords/song{i}.tfrecords" for i in range(1, num_samples+1)]
